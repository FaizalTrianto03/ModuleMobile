---
title: "Modul 0: Introducing Flutter, Configure Flutter Environment, Architecture, dan State Management"
description: "Setup Flutter environment, membuat Android Emulator, dan memahami dasar Flutter."
---
...
# _Introducing Flutter, Configure Flutter Environment, Architecture, dan State Management_
...
2. **Install Chocolatey**
   ...
   <CodeBlock desc="Install Chocolatey" language="powershell" code={`
   Set-ExecutionPolicy Bypass -Scope Process -Force; [System.Net.ServicePointManager]::SecurityProtocol = [System.Net.ServicePointManager]::SecurityProtocol -bor 3072; iex ((New-Object System.Net.WebClient).DownloadString('https://community.chocolatey.org/install.ps1'))
   `} />
   
   Verifikasi instalasi dengan `choco -v`
...
5. **Install Flutter via FVM**
   ...
   fvm install stable
   fvm global stable
   [Environment]::SetEnvironmentVariable("PATH", "$env:USERPROFILE\fvm\default\bin;$([Environment]::GetEnvironmentVariable('PATH','User'))", "User")
   `} />
