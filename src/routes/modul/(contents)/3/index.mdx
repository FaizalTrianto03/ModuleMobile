...
// Pemetaan ke file-file yang Anda lampirkan dalam repo modul.
// Pastikan path disesuaikan dengan struktur folder website Anda.
...
import contoh11Code from "./code/contohlogin.dart?raw";     // Future<bool> login()
...
<CodeBlock desc="URL API Publik" language="bash" code={contoh1Code} />

Contoh hasil response:

<CodeBlock desc="Contoh Response JSON" language="plaintext" code={contoh2Code} />
