...
- Hindari generics dengan tanda < > di teks biasa. Gunakan backticks: `Future<bool>` atau escape: Future&lt;bool&gt;.
- Untuk menghindari error SSG 'contoh1Code is not defined', dua blok awal di-inline.
  Jika file ./code tersedia, aktifkan import yang dikomentari dan ganti inline sesuai.
*/
