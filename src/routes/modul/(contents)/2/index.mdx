...
import contoh10Code from "./code/contoh10.dart?raw";
import contoh11Code from "./code/contoh11.dart?raw";
...
<CodeBlock desc="Pemilihan aset sesuai DPR" language="dart" code={contoh10Code} />
...
<CodeBlock desc="AnimatedContainer contoh" language="dart" code={contoh11Code} />
...
<CodeBlock desc="AnimationController + Tween" language="dart" code={contoh12Code} />
