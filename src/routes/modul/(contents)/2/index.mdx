...
***Satu. MediaQuery ( Mengetahui Kondisi Layar Global )***
...
***Dua. LayoutBuilder ( Menentukan Layout Berdasarkan Ruang Lokal )***
...
3. Pada LayoutBuilderDemoPage, satu grid ditempatkan di container sempit (250px) dan satu lagi di area utama. Hasilnya: jumlah kolom di kedua grid berbeda, walau menggunakan widget yang sama.
