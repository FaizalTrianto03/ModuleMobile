...
<CodeBlock desc="main.dart" language="dart" code={main} />
...
import ImgWidgetTree from "~/media/modul1/widget-tree.png?jsx";
...
[![Watch the video](https://img.youtube.com/vi/_EYk-E29edo/default.jpg)](https://youtu.be/_EYk-E29edo)
