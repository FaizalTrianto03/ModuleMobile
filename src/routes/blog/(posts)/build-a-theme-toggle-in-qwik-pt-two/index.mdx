...
```tsx
import type { ButtonHTMLAttributes } from "@qwik.dev/core";
import { component$ } from "@qwik.dev/core";
import {
...
export const DropdownMenu = component$(({ open, btnId }: DropdownMenuProps) => {
  return (
    <ul
      class="animate-drop-down-in ring-opacity-5 absolute right-0 z-10 m-0 mt-1 w-40 origin-top-right list-none rounded-lg bg-white p-0 shadow-sm ring-1 ring-black focus:outline-none dark:bg-black/90 dark:shadow-none dark:ring-zinc-700"
      role="menu"
      hidden={!open}
...
```tsx
import { Slot, component$, type ButtonHTMLAttributes } from "@qwik.dev/core";
