...
export const PostCard = component$(
  ({ title, slug, date, description }: Post) => {
    return (
      <div class="card bg-base-100 h-full shadow-xl transition-transform duration-200 hover:scale-105 hover:shadow-2xl">
        {/* Optional: Add a cover image here if available in the future */}
        <div class="card-body flex flex-col justify-between">
          <div>
            <h2 class="card-title mb-2 text-2xl font-bold">{title}</h2>
