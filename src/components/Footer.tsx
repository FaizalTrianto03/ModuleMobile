...
export const Footer = component$(() => (
  <>
    <footer class="footer sm:footer-horizontal bg-base-100 text-base-content border-base-300 border-t px-6 py-8">
      <nav>
        <h6 class="footer-title mb-2 text-base font-semibold">
          Modul Praktikum
        </h6>
      ...
      <nav>
        <h6 class="footer-title mb-2 text-base font-semibold">Company</h6>
        <Link
      ...
      <nav>
        <h6 class="footer-title mb-2 text-base font-semibold">Legal</h6>
        <button type="button" class="link link-hover">
          Terms of use
        </button>
        <button type="button" class="link link-hover">
    ...
    <footer class="footer bg-base-100 text-base-content border-base-300 mt-0 border-t px-6 py-4">
